	...
	<div class="box">
		...
		<form action="" method="post">
			<table class="profile-table">
				<tr><th>姓名：</th><td><input type="text"  name="name" value="<?php echo $students_info['name']; ?>"></td></tr>
				<tr><th>学号：</th><td><input type="text"  name="number" value="<?php echo $students_info['number']; ?>"></td></tr>
				<tr><th>班级：</th><td><input type="text"  name="class" value="<?php echo $students_info['class']; ?>"></td></tr>
